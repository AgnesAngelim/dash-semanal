...
async function startEdit(id) {
  ...
  g('fLogBackOffice').value         = r.logBackOffice        ?? 0;
  ...
  g('fPortAguardando').value = r.portAguardando ?? 0;
  ...
  g('fLogExtras').value     = r.logExtras     ?? 0;
...
function clearForm() {
  ...
  [
    ...
    'fPortAprovado', 'fPortAndamento', 'fPortAguardando', 'fPortNegado',
...
async function saveRecord() {
  ...
  const record = {
    ...
    logBackOffice:         gn('fLogBackOffice'),
    logContel:             gn('fLogContel'),
    ...
    portAguardando:        gn('fPortAguardando'),
