...
document.addEventListener('DOMContentLoaded', async () => {
  // Sempre faz logout ao carregar a página
  // Só permite acesso se vier do login (flag no sessionStorage)
  const veioDoLogin = sessionStorage.getItem('loginOk') === '1';
  sessionStorage.removeItem('loginOk');

  if (!veioDoLogin) {
    // Faz logout silencioso e redireciona para login
  ...
  // Chegou pelo login — adiciona botão de logout
